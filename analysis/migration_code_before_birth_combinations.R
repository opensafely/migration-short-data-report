###################################################
# This script describes the combinations of migration-related codes that are recorded before birth  
#
...
cohort_file <- "output/cohorts/migration_code_before_birth_cohort.arrow"
output_file <- "output/tables/migration_code_combinations_before_birth_summary.csv"
